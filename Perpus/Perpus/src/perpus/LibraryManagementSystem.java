...
public class LibraryManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        Book book3 = new Book("B003", "Harry Potter and the Sorcerer's Stone", "J.K. Rowling", 320);
        Book book4 = new Book("B004", "Sapiens: A Brief History of Humankind", "Yuval Noah Harari", 464);
        Book book5 = new Book("B005", "1984", "George Orwell", 328);
        Book book6 = new Book("B006", "Pride and Prejudice", "Jane Austen", 432);
        Book book7 = new Book("B007", "The Catcher in the Rye", "J.D. Salinger", 224);
        Book book8 = new Book("B008", "The Da Vinci Code", "Dan Brown", 592);
        Book book9 = new Book("B009", "The Alchemist", "Paulo Coelho", 208);
        Book book10 = new Book("B010", "The Hunger Games", "Suzanne Collins", 384);
        Book book11 = new Book("B011", "The Lord of the Rings", "J.R.R. Tolkien", 1178);
        Book book12 = new Book("B012", "Thinking, Fast and Slow", "Daniel Kahneman", 512);
        Book book13 = new Book("B013", "Quiet: The Power of Introverts in a World That Can't Stop Talking", "Susan Cain", 368);
        Book book14 = new Book("B014", "Educated", "Tara Westover", 400);
        ...
        library.addItem(book13);
        library.addItem(book14);
